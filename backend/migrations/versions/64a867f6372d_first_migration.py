...
Revision ID: 64a867f6372d
Revises: 
Create Date: 2023-12-07 12:44:24.852763
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('employee_job_title'),
    sa.UniqueConstraint('employee_name'),
    sa.UniqueConstraint('employee_password'),
    ...
    sa.UniqueConstraint('store_section_name')
    )
    ...
    sa.Column('incident_description', sa.Text(length=10000), nullable=False),
    ...
    sa.UniqueConstraint('incident_description'),
    sa.UniqueConstraint('is_resolved'),
    sa.UniqueConstraint('product_code'),
    sa.UniqueConstraint('product_name'),
    sa.UniqueConstraint('product_price'),
    sa.UniqueConstraint('product_quantity')
    )
