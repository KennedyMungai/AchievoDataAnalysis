...
const SideBar = (props: Props) => {
	return (
		<nav className='w-[6vw] h-screen flex flex-col justify-between border-r-[1px] dark:border-slate-500 border-slate-300 p-5 fixed bg-slate-50 dark:bg-slate-900'>
			<div className=''>
